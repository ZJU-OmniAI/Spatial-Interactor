...
class FileLogger(Logger):
    def __init__(self, config: dict[str, Any]) -> None:
        ...
        # Preserve monitoring history when EasyR1 resumes an existing experiment.
        for filename in ("experiment_log.jsonl", "generations.log"):
            with open(os.path.join(config["trainer"]["save_checkpoint_path"], filename), "a"):
                pass
