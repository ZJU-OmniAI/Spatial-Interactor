...
ROOM_SUBCAT_LIMITS = {
    "class01__two_image_single_action": 10,
    "class01__two_image_double_action": 10,
    "class01__multi_image_single_action_chain": 10,
    "class02__default": 18,
    "class03__default": 18,
    "class04__start_visible": 12,
    "class04__start_not_visible": 12,
    "class05__rotation": 10,
    "class05__translation": 10,
    "class06__rotate": 12,
    "class06__open_close": 12,
    "class06__toggle": 12,
    "class06__remove": 12,
    "class07__default": 18,
    "class08__distance_change": 18,
    "class08__occlusion_change": 18,
    "class09__default": 10,
    "class10__single_visibility": 12,
    "class10__two_frame_direction": 12,
    "class10__single_direction": 12,
    "class10__trend_disappear": 12,
}
...
def process_scene(args: argparse.Namespace, scene: str) -> dict:
    ...
    try:
        ...
        result = {
            ...
            "prefilter_candidate_positions": 0,
            "prefilter_selected_positions": 0,
            "prefilter_skipped_close_positions": 0,
            "probe_positions": 0,
            ...
            "candidate_position_groups": 0,
            "selected_position_groups": 0,
            "selected_full_groups": 0,
            "selected_global_groups": 0,
            "selected_hotspot_groups": 0,
            "selected_fallback_groups": 0,
        ...
        print(f"[scene_worker] failed scene={scene} error={exc}", flush=True)
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Process one or more ReplicaCAD scenes into state/proposal banks.")
