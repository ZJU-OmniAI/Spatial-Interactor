...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Build ProcTHOR state bank for fixed seeds.")
    parser.add_argument("--output-root", type=Path, default=DEFAULT_OUTPUT_ROOT)
    parser.add_argument("--scenes", type=str, default=None, help="Comma-separated ProcTHOR seeds or names")
