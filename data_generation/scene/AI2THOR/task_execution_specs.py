...
TASK_EXECUTION_SPECS: Dict[Tuple[int, str], TaskExecutionSpec] = {
    (1, "two_image_single_action"): TaskExecutionSpec(
        ...
        reference_source="/path/to/workspace/ALL/AI2THOR/1/meta/qa_data.json",
    ),
    ...
    (2, "default"): TaskExecutionSpec(
        ...
        reference_source="/path/to/workspace/ALL/AI2THOR/2/meta/qa_data.json",
    ),
    (3, "default"): TaskExecutionSpec(
        ...
        reference_source="/path/to/workspace/ALL/AI2THOR/3/meta/qa_data.json",
    ),
    (4, "start_visible"): TaskExecutionSpec(
        ...
        reference_source="/path/to/workspace/ALL/AI2THOR/4/meta/qa_data.json",
    ),
    ...
    (5, "translation"): TaskExecutionSpec(
        ...
        reference_source="/path/to/workspace/ALL/AI2THOR/5/meta/qa_data.json",
    ),
    ...
    (6, "rotate"): TaskExecutionSpec(
        ...
        reference_source="/path/to/workspace/ALL/AI2THOR/6/meta/qa_data.json",
    ),
    ...
    (7, "default"): TaskExecutionSpec(
        ...
        reference_source="/path/to/workspace/ALL/AI2THOR/7/meta/qa_data.json",
    ),
    (8, "distance_change"): TaskExecutionSpec(
        ...
        reference_source="/path/to/workspace/ALL/AI2THOR/8/meta/qa_data.json",
    ),
    ...
    (9, "default"): TaskExecutionSpec(
        ...
        reference_source="/path/to/workspace/ALL/AI2THOR/9/meta/qa_data.json",
    ),
    (10, "single_visibility"): TaskExecutionSpec(
        ...
        input_mode="single_frame_reasoning",
        reference_source="/path/to/workspace/ALL/AI2THOR/10/meta/qa_data.json",
    ),
