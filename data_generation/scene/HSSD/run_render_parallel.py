...
DEFAULT_SCENE_BANK_ROOT = Path("/path/to/workspace/SCENEOUTPUT/HSSD/output_prefilter_full_20260422")
DEFAULT_RENDER_OUTPUT_ROOT = Path("/path/to/workspace/SCENEOUTPUT/HSSD/render_output_prop_20260423")
...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="批量执行 HSSD scene bank proposals，逐proposal生成最终渲染样本。")
