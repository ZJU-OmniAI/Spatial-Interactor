...
# -*- coding: utf-8 -*-
"""
HSSD 第9类：想象代入视角 (Imagined Perspective Taking)
...
class HSSDImaginedPerspectiveGenerator:
    def __init__(
        self,
        output_root: str,
        dataset_root: str,
    ...
    def _run_one_sample(self, sample_idx: int, scene_path: str) -> Dict:
        ...
        return {
            ...
            "gt": {
                ...
                "axis_convention": "Habitat/HSSD局部坐标：Z为forward，X为right，Y为up",
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="HSSD 第9类：想象代入视角 数据生成器")
    parser.add_argument("--output_root", type=str, default="/path/to/workspace/HSSD/9")
...
def main() -> None:
    args = parse_args()
    gen = HSSDImaginedPerspectiveGenerator(
